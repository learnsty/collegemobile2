...
/*
OpenID has been around for a long while now...

1) How many web users take advantage of it ?
2) How many still just feel it's okay to maintain multiple logins ?
3) Why isn't there any effort on encouraging adoption ?
4) Are big companies wanting to build their own proprietary trust systems (creating duplication in the process) ?
5) The Web is getting filled up with redundant information about each individual and we feel this is okay ?
6) Can privacy concerns about private web information be reappraised to be uniform across Auth platforms ? 
7) What ideas are here now to solve the multiple login problem ?
*/